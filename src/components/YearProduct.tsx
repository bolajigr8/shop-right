...
const YearProduct = () => {
  return (
    <div className='w-full min-h-[300px]  bg-[#f3f3f3]  '>
      <Container className='md:bg-transparent relative py-0 mb-10'>
        ...
        />
        <div className='w-full  md:w-1/2  h-80 absolute px-4  top-0 right-0 flex flex-col items-start gap-6 justify-center'>
